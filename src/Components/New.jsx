...
const New = () => {
    ...
    const handleChange = (e) => {
        setNewBookmark((prevState) => {
            // we use the spread operator to continously update the value to the current character added to the input. 
        ...
        <form onSubmit={handleSubmit}>
            <fieldset>
                ...
                <input 
                    type="text" 
                    placeholder='URL'
                    // we use the name prop to reference of what the input is and update the value
                    name="url"
                    value={ newBookmark.url }
                    // OnChange records every character added in the input
                    onChange={ handleChange }
                />
                <br/>
                <input 
